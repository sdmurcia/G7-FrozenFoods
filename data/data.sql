...
insert into productos
(producto, descripcion, precio, image, descuento, Idcategoria, visitados)
values ('10 Albondigas', 'Carne de res molida especial, miga de pan, huevo , sal, albahaca y salsa nap�litana.', 4, 'albondigas.jpg', 2, 3, 'Si' );
insert into productos
(producto, descripcion, precio, image, descuento, Idcategoria, visitados)
values ('Alitas', 'Alitas de pollo marinadas con paprika, miel, mostaza, comino y sal.', 3, 'alitas.jpg', 5, 3, 'Si' );
insert into productos
(producto, descripcion, precio, image, descuento, Idcategoria, visitados)
values ('Lasa�a de pollo', 'Pechuga desmechada, tomates seleccionados, cebolla, pesto, hiervas aromatizantes.', 4, 'lasa�a-pollo.jpg', 10, 1, 'No' );
insert into productos
(producto, descripcion, precio, image, descuento, Idcategoria, visitados)
...
insert into productos
(producto, descripcion, precio, image, descuento, Idcategoria, visitados)
values ('Lasa�a vegetariana', 'Berenjenas, zuchinni verde y amarillo, piment�n ahumado, zanahoria, albahaca, salsa napolitana, queso mozarella y pasta.', 3, 'lasa�a-vege.jpg', 10, 4, 'No' );
insert into productos
(producto, descripcion, precio, image, descuento, Idcategoria, visitados)
...
insert into productos
(producto, descripcion, precio, image, descuento, Idcategoria, visitados)
values ('Callos a la Madrile�a', 'Menudo, pezu�a de cerdo, chorizo, garbanzos, pimenton, tomate, cebolla, perejil, chocolate y salsas de tomate.', 3.5, 'callos-madri.jpg', 0, 3, 'No' );
insert into productos
(producto, descripcion, precio, image, descuento, Idcategoria, visitados)
values ('Lomo stroganoff', 'Julianas de lomo de res con champi�ones en suave salsa de carne y crema de leche.', 4.5, 'stroganoff.jpg', 5, 3, 'Si' );
insert into productos
(producto, descripcion, precio, image, descuento, Idcategoria, visitados)
values ('Salmon grille', 'Lomo de Salm�n noruego, sal , pimienta y salsa de la casa.', 5, 'salmon.jpg', 10, 3, 'Si' );
